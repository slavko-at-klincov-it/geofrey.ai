...
`,
  ...
  "onboarding.whatsappTitle": "Set up WhatsApp via Twilio",
  "onboarding.whatsappPrereqs": `
  Prerequisites:
  1. Twilio account created (twilio.com)
  2. WhatsApp Sandbox enabled or own number requested
  3. Account SID + Auth Token from Twilio Console
  → Docs: https://www.twilio.com/docs/whatsapp
`,
  "onboarding.twilioAccountSid": "Account SID (starts with AC):",
  "onboarding.twilioAccountSidInvalid": "Invalid Account SID — must start with 'AC'",
  "onboarding.twilioAuthToken": "Auth Token:",
  "onboarding.twilioAuthTokenMissing": "Auth Token missing",
  "onboarding.connectionCheck": "Checking connection...",
  "onboarding.whatsappConnected": "Twilio account connected",
  "onboarding.whatsappConnectionFailed": "Connection failed — check Account SID and Auth Token",
  "onboarding.networkError": "Network error during validation",
  "onboarding.continueAnyway": "Continue anyway?",
  "onboarding.twilioWhatsAppNumber": "WhatsApp number (e.g. +14155238886):",
  "onboarding.twilioWhatsAppNumberMissing": "WhatsApp number missing",
  ...
  "onboarding.twilioWebhookHint": "Configure webhook URL in Twilio Console: https://your-domain:{port}/webhook",
...
`,
  ...
  "privacy.imageBlocked": "Image contains faces — blocked for privacy reasons.",
  "privacy.imageOcrOnly": "Image processed locally via OCR only (no cloud upload).",
  "privacy.imageClassifying": "Classifying image...",

  // privacy / approval flow
  "privacy.askAnonymize": "Detected {category}: \u201C{pattern}\u201D. Should I anonymize this?",
  "privacy.askScope": "Global (always) or only in this session?",
  "privacy.scopeGlobal": "Global (always)",
  "privacy.scopeSession": "This session only",
  "privacy.ruleCreated": "Privacy rule created: {pattern} \u2192 {action}",
  "privacy.noRules": "No privacy rules defined.",
  "privacy.rulesExported": "Privacy rules exported.",
  ...
  "localOps.copyDone": "Copied: {source} → {destination}",
  "localOps.moveDone": "Moved: {source} → {destination}",
  "localOps.searchReplaceNoMatch": "No matches for \"{search}\"",
  "localOps.searchReplaceDone": "{count} replacements in {path}",
  "localOps.diffIdentical": "Files are identical",
  "localOps.countLines": "{count} lines in {path}",
  "localOps.diskSpaceFailed": "Could not determine disk space",
  "localOps.envNotSet": "Environment variable not set: {name}",
  "localOps.archiveCreated": "Archive created: {path} ({size})",
  "localOps.archiveExtracted": "{count} files extracted to {destination}",
  "localOps.archivePathEscape": "Path in archive escapes destination: {path}",

  // billing - cost display
  "billing.costLine": "[Cloud: {cloudTokens} Tokens ({cloudCost}) | Local: {localTokens} Tokens ({localCost})]",

  // auto-tooling
  "autoTooling.proposal": "Missing capability: {capability} — Suggestion: {suggestion}",
  "autoTooling.buildStarted": "Building program in {dir}...",
  "autoTooling.buildComplete": "Program built successfully ({duration}s).",
  "autoTooling.buildFailed": "Build failed: {error}",
  "autoTooling.registered": "Registered as {type}: {detail}",
  "autoTooling.validationPassed": "Validation passed: {summary}",
  "autoTooling.validationFailed": "Validation failed: {summary}",
