...
`,
  ...
  "memory.stored": "In Kategorie '{category}' gespeichert",
  ...
  "memory.conflictWarning": "⚠ Möglicher Konflikt mit früherer Entscheidung: {content}",
  ...
  "onboarding.summaryTimezone": "Zeitzone:",
  "onboarding.summaryCalendar": "Kalender:",
  "onboarding.summaryNotes": "Notizen:",
  "onboarding.summaryTasks": "Aufgaben:",
  "onboarding.summaryMorning": "Morgenbriefing:",
  "onboarding.summaryProfileSaved": "Profil gespeichert in .geofrey/profile.json",
  ...
  // onboarding profile
  "onboarding.profile.title": "Dein Profil",
  "onboarding.profile.name": "Wie heißt du?",
  "onboarding.profile.timezone.confirm": "Deine Zeitzone ist {timezone} — stimmt das?",
  "onboarding.profile.timezone.enter": "Welche Zeitzone?",
  "onboarding.profile.workdir": "Wo liegen deine Projekte?",
  "onboarding.profile.workdir.custom": "Anderer Pfad...",
  "onboarding.profile.style": "Kommunikationsstil?",
  "onboarding.profile.style.formal": "Formell (Sie)",
  "onboarding.profile.style.casual": "Locker (du)",
  "onboarding.profile.style.mixed": "Gemischt",
  "onboarding.profile.interests": "Interessen/Themen (optional, kommasepariert):",
  "onboarding.profile.interests.hint": "z.B. TypeScript, Machine Learning, DevOps",

  // onboarding integrations
  "onboarding.integrations.title": "Integrationen",
  "onboarding.integrations.calendar": "Welche Kalender-App nutzt du?",
  "onboarding.integrations.calendar.google": "Google Calendar",
  "onboarding.integrations.calendar.caldav": "CalDAV",
  "onboarding.integrations.calendar.none": "Keine",
  "onboarding.integrations.calendar.google.oauth": "Möchtest du jetzt Google OAuth verbinden?",
  "onboarding.integrations.calendar.caldav.url": "CalDAV-URL:",
  "onboarding.integrations.notes": "Welche Notizen-App?",
  ...
  "onboarding.integrations.notes.files": "Dateien/Ordner",
  "onboarding.integrations.notes.none": "Keine",
  "onboarding.integrations.notes.obsidian.path": "Obsidian Vault-Pfad:",
  "onboarding.integrations.notes.notion.key": "Notion API Key:",
  "onboarding.integrations.notes.files.dir": "Notizen-Verzeichnis:",
  "onboarding.integrations.tasks": "Welche Task-App?",
  ...
  "onboarding.integrations.tasks.none": "Keine",
  "onboarding.integrations.tasks.todoist.key": "Todoist API Key:",

  // onboarding proactive
  "onboarding.proactive.title": "Proaktive Funktionen",
  "onboarding.proactive.morning": "Möchtest du einen täglichen Morning Brief?",
  "onboarding.proactive.morning.time": "Um welche Uhrzeit? (HH:MM)",
  "onboarding.proactive.calendar": "Kalender-Erinnerungen vor Terminen?",
  "onboarding.proactive.calendar.minutes": "Wie viele Minuten vorher?",
  "onboarding.proactive.email": "Email-Benachrichtigungen bei wichtigen Mails?",
  "onboarding.proactive.email.vip": "VIP-Absender (kommasepariert):",
  "onboarding.proactive.email.keywords": "Keywords für wichtige Mails (kommasepariert):",
  ...
  "proactive.morning.email.section": "Ungelesene E-Mails",
  "proactive.morning.memory.section": "Erinnerungen",
  "proactive.morning.empty": "Heute steht nichts Besonderes an.",
  "proactive.calendar.reminder": "In {minutes} Minuten: {event}",
  "proactive.email.alert": "Neue wichtige Mail von {sender}: {subject}",
  "proactive.email.vip": "VIP-Mail von {sender}",
  "proactive.no.events": "Keine Termine heute.",
  "proactive.no.emails": "Keine neuen E-Mails.",
  "proactive.calendar.prep.hint": "Bereite auch kurze Gesprächsnotizen oder Talking Points für die Termine vor, basierend auf der Beschreibung und dem Kontext aus dem Memory.",
  "proactive.morning.tasks.section": "Deine Aufgaben heute",
  "proactive.no.tasks": "Keine Aufgaben für heute.",
